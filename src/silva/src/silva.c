...
int main(const int argc, const char **argv) {
    ...
    double time_spent_for_initialization = 0.0;
    time_spent_for_initialization += (double)(end - begin) / CLOCKS_PER_SEC;

    printf("The elapsed time for inizialitazion is %f seconds\n", time_spent_for_initialization);
